    ...
    <div class="container-fluid bg-light rounded-3 mx-auto" style="width: 98%">
        <form action="/zapatos" method="POST">
            ...
            <div class="mb-3">
                ...
                <input id="modelo" name="modelo" type="text" class="form-control" pattern="^[A-Za-z0-9áéíóúüñÑÁÉÍÓÚÜ\s]{2,30}$" title="No se aceptan caracteres especiales" tabindex="1">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Marca</label>
                <input id="marca" name="marca" type="text" class="form-control" pattern="^[A-Za-z0-9áéíóúüñÑÁÉÍÓÚÜ\s]{2,30}$" title="No se aceptan caracteres especiales" tabindex="2">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Color</label>
                <input id="color" name="color" type="text" class="form-control" pattern="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\d;\/,.\-_]{2,30}$" title="No se aceptan caracteres especiales" tabindex="3">
            </div>
            <div class="mb-3">
